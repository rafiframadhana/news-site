...
import { FiUsers, FiFileText, FiEye, FiTrendingUp, FiPlus, FiEdit3 } from 'react-icons/fi';
        ...
        {dashboardStats.recentArticles.length > 0 ? (
          <div className="space-y-4">
            {dashboardStats.recentArticles.map((article) => (
              <div key={article._id} className="flex items-center justify-between py-3 border-b border-gray-200 last:border-b-0">
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{article.title}</h3>
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    <span>By {article.author?.fullName || article.author?.username || 'Unknown'}</span>
